...
class RedirectHandler(object):
    ...
    def get_pending_by_state(self, state):
        return self.get_pending_by_field_one('state', state)

    def get_pending_by_nonce(self, nonce):
        return self.get_pending_by_field_one('nonce', nonce)
    ...
    def get_pending_by_field_one(self, fieldname, fieldval):
        pending = self.get_pending_by_field(fieldname, fieldval)
        if len(pending) != 1:
            return None
        else:
            return pending[0]
